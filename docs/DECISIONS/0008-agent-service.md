...
**Production:** Durable repositories, distributed nonce coordination, managed proposal-signing custody, monitoring, rate limits, incident response, credential rotation, and high availability remain deferred.
