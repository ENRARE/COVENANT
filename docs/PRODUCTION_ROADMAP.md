...
Covenant domain boundary. COV-023 adds the private durable runtime and
non-authoritative persistence boundary in `@covenant/runtime`; it does not add
public routes, webhooks, or SDK runtime behavior. COV-024 remains separately
accepted work.
