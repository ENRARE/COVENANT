...
export type RuntimeOperation = Readonly<{
  ...
  arcEvidence: unknown;
  /** Verified, externally produced authority evidence retained for the
   * isolated executor. This is never generated by the runtime or API. */
  authorizationEvidence: AuthorizationEvidenceSubmission | null;
